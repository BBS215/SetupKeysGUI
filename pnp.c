...
static HANDLE						SETUPAPUDLLModuleHandle = NULL;
t_SetupDiDestroyDeviceInfoList		dll_SetupDiDestroyDeviceInfoList = NULL;
t_SetupDiEnumDeviceInterfaces		dll_SetupDiEnumDeviceInterfaces = NULL;
t_SetupDiGetDeviceInterfaceDetailA	dll_SetupDiGetDeviceInterfaceDetailA = NULL;
t_SetupDiGetDeviceInterfaceDetailW	dll_SetupDiGetDeviceInterfaceDetailW = NULL;
t_SetupDiGetClassDevsA				dll_SetupDiGetClassDevsA = NULL;
t_SetupDiGetClassDevsW				dll_SetupDiGetClassDevsW = NULL;
static HANDLE						HIDDLLModuleHandle = NULL;
t_HidD_GetHidGuid					dll_HidD_GetHidGuid = NULL;
t_HidP_SetUsageValue				dll_HidP_SetUsageValue = NULL;
t_HidD_GetInputReport				dll_HidD_GetInputReport = NULL;
t_HidP_GetCaps						dll_HidP_GetCaps = NULL;
t_HidP_GetButtonCaps				dll_HidP_GetButtonCaps = NULL;
t_HidP_GetValueCaps					dll_HidP_GetValueCaps = NULL;
t_HidP_MaxUsageListLength			dll_HidP_MaxUsageListLength = NULL;
t_HidD_GetAttributes				dll_HidD_GetAttributes = NULL;
t_HidD_GetPreparsedData				dll_HidD_GetPreparsedData = NULL;
t_HidD_FreePreparsedData			dll_HidD_FreePreparsedData = NULL;

int LoadHIDLib(void)
{
	int ret = 0;
#ifdef UNICODE
	SETUPAPUDLLModuleHandle = LoadLibrary(L"SETUPAPI.DLL");
#else
	SETUPAPUDLLModuleHandle = LoadLibrary("SETUPAPI.DLL");
#endif // !UNICODE
	if (!SETUPAPUDLLModuleHandle) { ret = -1; goto err_exit; }

#ifdef UNICODE
	HIDDLLModuleHandle = LoadLibrary(L"HID.DLL");
#else
	HIDDLLModuleHandle = LoadLibrary("HID.DLL");
#endif // !UNICODE
	if (!HIDDLLModuleHandle) { ret = -2; goto err_exit; }


	dll_SetupDiDestroyDeviceInfoList = (t_SetupDiDestroyDeviceInfoList)GetProcAddress(SETUPAPUDLLModuleHandle, "SetupDiDestroyDeviceInfoList");
	if (!dll_SetupDiDestroyDeviceInfoList) { ret = -3; goto err_exit; }
	dll_SetupDiEnumDeviceInterfaces = (t_SetupDiEnumDeviceInterfaces)GetProcAddress(SETUPAPUDLLModuleHandle, "SetupDiEnumDeviceInterfaces");
	if (!dll_SetupDiEnumDeviceInterfaces) { ret = -4; goto err_exit; }
	dll_SetupDiGetDeviceInterfaceDetailA = (t_SetupDiGetDeviceInterfaceDetailA)GetProcAddress(SETUPAPUDLLModuleHandle, "SetupDiGetDeviceInterfaceDetailA");
	if (!dll_SetupDiGetDeviceInterfaceDetailA) { ret = -5; goto err_exit; }
	dll_SetupDiGetDeviceInterfaceDetailW = (t_SetupDiGetDeviceInterfaceDetailW)GetProcAddress(SETUPAPUDLLModuleHandle, "SetupDiGetDeviceInterfaceDetailW");
	if (!dll_SetupDiGetDeviceInterfaceDetailW) { ret = -6; goto err_exit; }
	dll_SetupDiGetClassDevsA = (t_SetupDiGetClassDevsA)GetProcAddress(SETUPAPUDLLModuleHandle, "SetupDiGetClassDevsA");
	if (!dll_SetupDiGetClassDevsA) { ret = -7; goto err_exit; }
	dll_SetupDiGetClassDevsW = (t_SetupDiGetClassDevsW)GetProcAddress(SETUPAPUDLLModuleHandle, "SetupDiGetClassDevsW");
	if (!dll_SetupDiGetClassDevsW) { ret = -8; goto err_exit; }

	dll_HidD_GetHidGuid = (t_HidD_GetHidGuid)GetProcAddress(HIDDLLModuleHandle, "HidD_GetHidGuid");
	if (!dll_HidD_GetHidGuid) { ret = -9; goto err_exit; }
	dll_HidP_SetUsageValue = (t_HidP_SetUsageValue)GetProcAddress(HIDDLLModuleHandle, "HidP_SetUsageValue");
	if (!dll_HidP_SetUsageValue) { ret = -10; goto err_exit; }
	dll_HidD_GetInputReport = (t_HidD_GetInputReport)GetProcAddress(HIDDLLModuleHandle, "HidD_GetInputReport");
	if (!dll_HidD_GetInputReport) { ret = -11; goto err_exit; }
	dll_HidP_GetCaps = (t_HidP_GetCaps)GetProcAddress(HIDDLLModuleHandle, "HidP_GetCaps");
	if (!dll_HidP_GetCaps) { ret = -12; goto err_exit; }
	dll_HidP_GetButtonCaps = (t_HidP_GetButtonCaps)GetProcAddress(HIDDLLModuleHandle, "HidP_GetButtonCaps");
	if (!dll_HidP_GetButtonCaps) { ret = -13; goto err_exit; }
	dll_HidP_GetValueCaps = (t_HidP_GetValueCaps)GetProcAddress(HIDDLLModuleHandle, "HidP_GetValueCaps");
	if (!dll_HidP_GetValueCaps) { ret = -14; goto err_exit; }
	dll_HidP_MaxUsageListLength = (t_HidP_MaxUsageListLength)GetProcAddress(HIDDLLModuleHandle, "HidP_MaxUsageListLength");
	if (!dll_HidP_MaxUsageListLength) { ret = -15; goto err_exit; }
	dll_HidD_GetAttributes = (t_HidD_GetAttributes)GetProcAddress(HIDDLLModuleHandle, "HidD_GetAttributes");
	if (!dll_HidD_GetAttributes) { ret = -16; goto err_exit; }
	dll_HidD_GetPreparsedData = (t_HidD_GetPreparsedData)GetProcAddress(HIDDLLModuleHandle, "HidD_GetPreparsedData");
	if (!dll_HidD_GetPreparsedData) { ret = -17; goto err_exit; }
	dll_HidD_FreePreparsedData = (t_HidD_FreePreparsedData)GetProcAddress(HIDDLLModuleHandle, "HidD_FreePreparsedData");
	if (!dll_HidD_FreePreparsedData) { ret = -18; goto err_exit; }
	return 0;
...
{
	if (SETUPAPUDLLModuleHandle) {
		FreeLibrary(SETUPAPUDLLModuleHandle);
		SETUPAPUDLLModuleHandle = NULL;
	}
	if (HIDDLLModuleHandle) {
		FreeLibrary(HIDDLLModuleHandle);
		HIDDLLModuleHandle = NULL;
	}
}
...
--*/
{
    ...
    *NumberDevices = 0;
    ...
    //
    hardwareDeviceInfo = dll_SetupDiGetClassDevs ( &hidGuid,
    ...
    while (!done)
    {
        *NumberDevices *= 2;
        ...
        for (; i < *NumberDevices; i++, hidDeviceInst++)
        {
            ...
            if (dll_SetupDiEnumDeviceInterfaces (hardwareDeviceInfo,
                                             ...
                                             &deviceInfoData))
            {
                ...
                dll_SetupDiGetDeviceInterfaceDetail (
                        hardwareDeviceInfo,
                        &deviceInfoData,
                ...
                if (dll_SetupDiGetDeviceInterfaceDetail (
                           hardwareDeviceInfo,
                           &deviceInfoData,
                           ...
                           NULL))
                {
                                   ...
                                   hidDeviceInst))
                    {
                        ...
                        iDevicePathSize = ((INT)_tcslen(functionClassDeviceData -> DevicePath) + 1) * sizeof(TCHAR);
...
Done:
    ...
    if (INVALID_HANDLE_VALUE != hardwareDeviceInfo)
    {
        dll_SetupDiDestroyDeviceInfoList (hardwareDeviceInfo);
...
--*/
{
    ...
    if (!dll_HidD_GetPreparsedData (HidDevice->HidDevice, &HidDevice->Ppd))
    {
        goto Done;
    }

    if (!dll_HidD_GetAttributes (HidDevice->HidDevice, &HidDevice->Attributes))
    {
        goto Done;
    }

    if (!dll_HidP_GetCaps (HidDevice->Ppd, &HidDevice->Caps))
    {
        goto Done;
    }
...
)
{
    ...
    HidDevice->InputReportBuffer = (PCHAR)
        calloc (HidDevice->Caps.InputReportByteLength?HidDevice->Caps.InputReportByteLength:1, sizeof (CHAR));
    ...
    HidDevice->InputButtonCaps = buttonCaps = (PHIDP_BUTTON_CAPS)
        calloc (HidDevice->Caps.NumberInputButtonCaps?HidDevice->Caps.NumberInputButtonCaps:1, sizeof (HIDP_BUTTON_CAPS));
    ...
    HidDevice->InputValueCaps = valueCaps = (PHIDP_VALUE_CAPS)
        calloc (HidDevice->Caps.NumberInputValueCaps?HidDevice->Caps.NumberInputValueCaps:1, sizeof (HIDP_VALUE_CAPS));
    ...
    if(numCaps > 0)
    {
        if(HIDP_STATUS_SUCCESS != (dll_HidP_GetButtonCaps (HidP_Input,
                            buttonCaps,
                            &numCaps,
                            HidDevice->Ppd)))
        {
    ...
    if(numCaps > 0)
    {
        if(HIDP_STATUS_SUCCESS != (dll_HidP_GetValueCaps (HidP_Input,
                           valueCaps,
                           &numCaps,
                           HidDevice->Ppd)))
        {
    ...
    numValues = 0;
	for (i = 0; i < (ULONG)HidDevice->Caps.NumberInputValueCaps; i++, valueCaps++)
    {
    ...
    HidDevice->InputData = data = (PHID_DATA)
        calloc (HidDevice->InputDataLength? HidDevice->InputDataLength:1, sizeof (HID_DATA));
    ...
    dataIdx = 0;
    for (i = 0;
		 i < (ULONG)HidDevice->Caps.NumberInputButtonCaps;
         i++, data++, buttonCaps++, dataIdx++)
    {
        ...
        data->ButtonData.MaxUsageLength = dll_HidP_MaxUsageListLength (
                                                HidP_Input,
                                                buttonCaps->UsagePage,
                                                HidDevice->Ppd);
        data->ButtonData.Usages = (PUSAGE)
            calloc (data->ButtonData.MaxUsageLength? data->ButtonData.MaxUsageLength:1, sizeof (USAGE));
    ...
    HidDevice->OutputReportBuffer = (PCHAR)
        calloc (HidDevice->Caps.OutputReportByteLength? HidDevice->Caps.OutputReportByteLength:1, sizeof (CHAR));

    HidDevice->OutputButtonCaps = buttonCaps = (PHIDP_BUTTON_CAPS)
        calloc (HidDevice->Caps.NumberOutputButtonCaps? HidDevice->Caps.NumberOutputButtonCaps:1, sizeof (HIDP_BUTTON_CAPS));
    ...
    HidDevice->OutputValueCaps = valueCaps = (PHIDP_VALUE_CAPS)
        calloc (HidDevice->Caps.NumberOutputValueCaps? HidDevice->Caps.NumberOutputValueCaps:1, sizeof (HIDP_VALUE_CAPS));
    ...
    if(numCaps > 0)
    {
        if(HIDP_STATUS_SUCCESS != (dll_HidP_GetButtonCaps (HidP_Output,
                            buttonCaps,
                            &numCaps,
                            HidDevice->Ppd)))
        {
    ...
    if(numCaps > 0)
        {
        if(HIDP_STATUS_SUCCESS != (dll_HidP_GetValueCaps (HidP_Output,
                           valueCaps,
                           &numCaps,
                           HidDevice->Ppd)))
        {
    ...
    numValues = 0;
	for (i = 0; i < (ULONG)HidDevice->Caps.NumberOutputValueCaps; i++, valueCaps++)
    {
        if (valueCaps->IsRange)
        {
    ...
    HidDevice->OutputData = data = (PHID_DATA)
       calloc (HidDevice->OutputDataLength? HidDevice->OutputDataLength:1, sizeof (HID_DATA));
    ...
    for (i = 0;
		 i < (ULONG)HidDevice->Caps.NumberOutputButtonCaps;
         i++, data++, buttonCaps++)
    {
		...
		if((ULONG)((valueCaps->Range).UsageMin) == tmpSum)
        {
			goto Done;
        }
    ...
    HidDevice->FeatureReportBuffer = (PCHAR)
           calloc (HidDevice->Caps.FeatureReportByteLength? HidDevice->Caps.FeatureReportByteLength:1, sizeof (CHAR));

    HidDevice->FeatureButtonCaps = buttonCaps = (PHIDP_BUTTON_CAPS)
        calloc (HidDevice->Caps.NumberFeatureButtonCaps? HidDevice->Caps.NumberFeatureButtonCaps:1, sizeof (HIDP_BUTTON_CAPS));
    ...
    HidDevice->FeatureValueCaps = valueCaps = (PHIDP_VALUE_CAPS)
        calloc (HidDevice->Caps.NumberFeatureValueCaps? HidDevice->Caps.NumberFeatureValueCaps:1, sizeof (HIDP_VALUE_CAPS));
    ...
    if(numCaps > 0)
    {
        if(HIDP_STATUS_SUCCESS != (dll_HidP_GetButtonCaps (HidP_Feature,
                            buttonCaps,
                            &numCaps,
                            HidDevice->Ppd)))
        {
    ...
    if(numCaps > 0)
    {
        if(HIDP_STATUS_SUCCESS != (dll_HidP_GetValueCaps (HidP_Feature,
                           valueCaps,
                           &numCaps,
                           HidDevice->Ppd)))
        {
    ...
    numValues = 0;
	for (i = 0; i < (ULONG)HidDevice->Caps.NumberFeatureValueCaps; i++, valueCaps++)
    {
        if (valueCaps->IsRange)
        {
            numValues += valueCaps->Range.UsageMax
    ...
    HidDevice->FeatureData = data = (PHID_DATA)
        calloc (HidDevice->FeatureDataLength? HidDevice->FeatureDataLength:1, sizeof (HID_DATA));
    ...
    dataIdx = 0;
    for (i = 0;
		 i < (ULONG)HidDevice->Caps.NumberFeatureButtonCaps;
         i++, data++, buttonCaps++, dataIdx++)
    {
        data->IsButtonData = TRUE;
        data->Status = HIDP_STATUS_SUCCESS;
...
)
{
    ...
    {
        dll_HidD_FreePreparsedData(HidDevice -> Ppd);
        HidDevice -> Ppd = NULL;
    }
